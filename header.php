...
<head>
    ...
    <link rel="preload"
        href="<?=get_stylesheet_directory_uri()?>/fonts/lato-v17-latin-regular.woff2"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload"
        href="<?=get_stylesheet_directory_uri()?>/fonts/lato-v17-latin-regular.woff"
        as="font" type="font/woff" crossorigin="anonymous">
    <link rel="preload"
        href="<?=get_stylesheet_directory_uri()?>/fonts/libre-baskerville-v9-latin-regular.woff2"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload"
        href="<?=get_stylesheet_directory_uri()?>/fonts/libre-baskerville-v9-latin-regular.woff"
        as="font" type="font/woff" crossorigin="anonymous">
    <?php
    if (is_front_page()) {
        ?>
...
?>
    <div class="site" id="page">
        <div id="wrapper-navbar" class="fixed-top">
            <nav id="main-nav" class="navbar navbar-expand-lg d-block p-0 pt-2 pt-lg-0"
                            ...
                            <ul id="top-nav"
                                ...
                                <li class="menu-item nav-item">
                                    <a title="Email"
                                        ...
                                        class="nav-link"><i class="fas fa-envelope"></i>
                                        <?=get_field('contact_email', 'options')?></a>
                                </li>
                                <li class="menu-item nav-item">
                                    <a title="Phone"
                                        href="tel:<?=parse_phone(get_field('contact_phone', 'options'))?>"
                                        class="nav-link"><i class="fas fa-phone-alt"></i>
                                        <?=get_field('contact_phone', 'options')?></a>
                                </li>
                                <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"
                                    class="menu-item nav-item">
                                    <a title="Get a Quote" href="/get-a-quote/"
                                        class="mt-2 mt-lg-0 btn btn-topnav d-block d-sm-inline-block">Get a Quote</a>
                                </li>
                            </ul>
                        </div>
                        <?php
