...
<section class="text_image_5050 py-4 bg--<?=$bg?>">
    <div class="container animated wow fadeIn">
        <div class="row g-4">
            <div
                class="col-lg-6 text_image_5050__content <?=$order_left?>">
                <?php
                if (get_field('title')) {
...
?>
            ...
            <div
                class="col-lg-6 text_image_5050__image <?=$order_right?> px-lg-5">
                <img class="img-fluid"
                    src="<?=wp_get_attachment_image_url(get_field('image'), 'full')?>">
            </div>
        </div>
    </div>
    <?php
    if (get_field('full_height')) {
        ?>
    <div class="nav-arrow"><a href="#page<?=$pp?>"><i
