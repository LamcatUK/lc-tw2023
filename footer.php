        ...
        <div class="row pb-4">
            <div class="col-sm-6 col-lg-3 mb-2">
                <a href="<?=get_home_url()?>"><img
                        src="<?=get_stylesheet_directory_uri()?>/img/tw-logo.svg"
                        alt="Tidey & Webb" class="logo img-fluid mb-4"></a>
            ...
            <div class="col-sm-6 col-lg-3 mb-2">
                <ul class="fa-ul">
                    ...
                    <li><span class="fa-li"><i class="fas fa-fax"></i></span>
    ...
    <div class="container-xl py-2">
        <div class="row">
            <div class="col-md-6 mb-2 mb-md-0">
                &copy; <?=date('Y')?> Tidey &amp;
                Webb Ltd. Registered in England No. 01329531
            </div>
            <div class="col-md-6 text-md-end">
                <a href="/privacy-policy/">Privacy Policy</a> | <a href="/cookie-policy/">Cookie Policy</a>
                <!-- | <a href="/terms-conditions/">Terms &amp; Conditions</a> --> | Site by <a
                    href="https://www.lamcat.co.uk/" rel="nofollow noopener" target="_blank" class="lc"
